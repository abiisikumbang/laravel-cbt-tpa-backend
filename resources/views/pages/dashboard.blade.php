                            ...
                            <ul class="list-unstyled list-unstyled-border">
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="media-title">Haikal</div>
                                        <span class="text-small text-muted">umak programmer
                                            kacau, gokil parah</span>
                                    </div>
                                </li>
                                <li class="media">
                                    <img class="rounded-circle mr-3"
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="media-title">joe</div>
                                        <span class="text-small text-muted">kelass</span>
                                    </div>
                                </li>
                                <li class="media">
                                    <img class="rounded-circle mr-3"
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="media-title">Indra</div>
                                        <span class="text-small text-muted">kasuss</span>
                                    </div>
                                </li>
                                <li class="media">
                                    <img class="rounded-circle mr-3"
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="media-title">hafiz</div>
                                        <span class="text-small text-muted">gila</span>
                                    </div>
                                </li>
                            </ul>
